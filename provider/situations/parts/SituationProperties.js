    ...
    group.entries.push(entryFactory.textField({
      ...
      validate: function(element, values) {
		...
		if (element.parent.children[kind].businessObject.$attrs.participant != undefined){
			...
			for(var y = 0; y < sourceScope.attachers.length; y++){
				if (sourceScope.attachers[y].businessObject.suitable == element.businessObject.suitable){
					var violation = sourceScope.attachers[y].businessObject.$attrs.violation;
					element.businessObject.$attrs.violation = sourceScope.attachers[y].businessObject.$attrs.violation;
				}
			}
		}
  ...
  group.entries.push(entryFactory.textField({
    ...
    validate: function(element, values) {
	  ...
	  if (element.parent.children[kind].businessObject.$attrs.participant != undefined){
			...
			for(var y = 0; y < sourceScope.attachers.length; y++){
				if (sourceScope.attachers[y].businessObject.suitable == element.businessObject.suitable){
					var violation2 = sourceScope.attachers[y].businessObject.$attrs.violation2;
					element.businessObject.$attrs.violation2 = sourceScope.attachers[y].businessObject.$attrs.violation2;
				}
			}
		}
  ...
  group.entries.push(entryFactory.textField({
    ...
    validate: function(element, values) {
	  ...
	  if (element.parent.children[kind].businessObject.$attrs.participant != undefined){
			...
			for(var y = 0; y < sourceScope.attachers.length; y++){
				if (sourceScope.attachers[y].businessObject.suitable == element.businessObject.suitable){
					var violation3 = sourceScope.attachers[y].businessObject.$attrs.violation3;
					element.businessObject.$attrs.violation3 = sourceScope.attachers[y].businessObject.$attrs.violation3;
				}
			}
		}
...
group.entries.push(entryFactory.textField({
  ...
  validate: function(element, values) {
	...
	if (element.parent.children[kind].businessObject.$attrs.participant != undefined){
			...
			for(var y = 0; y < sourceScope.attachers.length; y++){
				if (sourceScope.attachers[y].businessObject.suitable == element.businessObject.suitable){
					var violation4 = sourceScope.attachers[y].businessObject.$attrs.violation4;
					element.businessObject.$attrs.violation4 = sourceScope.attachers[y].businessObject.$attrs.violation4;
				}
			}
		}
...
group.entries.push(entryFactory.textField({
  ...
  validate: function(element, values) {
	...
	if (element.parent.children[kind].businessObject.$attrs.participant != undefined){
			...
			for(var y = 0; y < sourceScope.attachers.length; y++){
				if (sourceScope.attachers[y].businessObject.suitable == element.businessObject.suitable){
					var violation5 = sourceScope.attachers[y].businessObject.$attrs.violation5;
					element.businessObject.$attrs.violation5 = sourceScope.attachers[y].businessObject.$attrs.violation5;
				}
			}
		}
